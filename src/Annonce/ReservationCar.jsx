...
export default function ReservationCar({title,imgUrl,reservationRate,description,price}) {
  ...
  <div class="p-3 w-full rounded-lg"> 
                    <div class="bg-white border shadow-md  text-gray-500 rounded-lg"> 
                           <a className=''><img src={imgUrl} class="hover:opacity-90 w-full rounded-t-lg" style={{  height: '400px' }}/></a>
                           <div class="p-6">
