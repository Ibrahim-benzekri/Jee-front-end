...
export default function BookingPage() {
  ...
  const fetchUser = async () => {
    try {
      ...
      const response = await fetch(
        `http://localhost:8081/api/v1/form/verify?token=${jwt}`,
        requestOptions
      );
      if (!response.ok) {
  ...
  const fetchCar = async () => {
    try {
      ...
      const response = await fetch(
        `http://localhost:8081/api/v1/Car/${id}`,
        requestOptions
      );
  ...
  const sendData = async () => {
    try {
      ...
      const response = await fetch(
        "http://localhost:8081/api/v1/bookingRequest",
        requestOptions
      );
    ...
    <section class="bg-white ">
      <div class="container px-6 py-12 mx-auto">
        ...
        <div>
          ...
          <h1 class="mt-2 text-2xl font-normal text-gray-800  ">
            Please fill out this form and confirm your reservation
          </h1>
        </div>
        ...
        <div class="grid grid-cols-1 gap-12 mt-5 lg:grid-cols-2">
          <ReservationCar
            ...
            price={car.price}
            reservationRate={car.reservationRate}
          />
            ...
            <div className="space-y-14">
              <div class="-mx-2 md:items-center md:flex">
                <div class="flex-1 px-2">
                  ...
                  <input
                    ...
                    onChange={changement}
                    name="pickUpDate"
                    class="block w-full px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg  focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40"
                  />
                </div>
              ...
              <div class="mt-4">
                ...
                <input
                  ...
                  onChange={changement}
                  name="adress"
                  placeholder="Bd Zerktouni, Casablanca"
                  class="block w-full px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg  focus:border-blue-400  focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40"
                />
              </div>
