        ...
        <div className="mt-12">
          <div className="mb-12 grid gap-y-6 gap-x-6 md:grid-cols-2 xl:grid-cols-3">
            <div className="rounded overflow-hidden shadow-lg flex flex-col">
              ...
              <div className="px-6 py-4 mb-auto h-44 overflow-scroll">
                <p className="font-medium text-lg inline-block text-indigo-600 mb-2">
                  Mustang GT
                </p>
                <p className="text-gray-500 text-sm">
                  Non cupidatat elit voluptate elit deserunt. Deserunt dolor
                  nisi nostrud amet ullamco proident aliqua sunt duis incididunt
                  sunt sunt. Dolore occaecat laborum tempor nisi. Ipsum nulla
                  eiusmod ad aliqua sit minim elit. Nostrud aute qui ut cillum
                  excepteur deserunt. Culpa et elit veniam consequat amet
              ...
              <div className="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
                <span className="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
                  ...
                  <span className="ml-1">100$/day</span>
                </span>
                ...
                <span className="mx-3 py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
                  ...
                  >
                    ...
                    <g id="SVGRepo_iconCarrier">
                      ...
                      <g>
                        ...
                        <g>
                          {" "}
                          <circle cx="99.7" cy="49.351" r="40.72"></circle>{" "}
                        </g>{" "}
                      </g>{" "}
                      <g>
                        {" "}
                  ...
                  <span className="ml-1">39 Reservations</span>
                </span>
                <span className="mx-3 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
                  <div className="flex flex-col items-center justify-center">
                    <Link className="mb-2 text-white bg-green-600 p-1 rounded-md w-11 text-center">
                      Edit
                    </Link>
                    <Link className="text-white bg-red-600 p-1 rounded-md w-11 text-center">
                      Delete
                    </Link>
                  </div>
                </span>
