...
export default function Register() {
  ...
  const mutation = useMutation({
    mutationFn: (data) => {
      return axios.post("http://localhost:8081/api/v1/form/register", data);
    },
    onMutate: (variables) => {
  ...
  return (
    <div className="h-full bg-black">
      <div
        className="absolute flex items-center justify-center w-full h-[100vh] text-gray-100 bg-gray-950 bg-opacity-70 hidden"
        id="loader"
      >
        <div>
